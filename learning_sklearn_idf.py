...
train_df = pd.read_csv('dataframes/tfidf_train_df.csv.gz', index_col=0)
print('Loaded train dataframe')
print('Loading test dataframe...')
test_df = pd.read_csv('dataframes/tfidf_test_df.csv.gz', index_col=0)
...
pd.DataFrame(results).to_csv('res_idf.csv')
